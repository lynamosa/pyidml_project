...
from pyidml.oxml.chart.chart import CT_Chart
from pyidml.oxml.ns import nsdecls
from pyidml.oxml.shapes.shared import BaseShapeElement
from pyidml.oxml.simpletypes import XsdBoolean, XsdString
from pyidml.oxml.table import CT_Table
