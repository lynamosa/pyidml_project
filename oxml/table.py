...
from pyidml.enum.text import MSO_VERTICAL_ANCHOR
...
from pyidml.oxml.simpletypes import ST_Coordinate, ST_Coordinate32, XsdBoolean, XsdInt
from pyidml.oxml.text import CT_TextBody
