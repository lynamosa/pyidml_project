...
from pyidml.enum.text import (
    MSO_AUTO_SIZE,
    MSO_TEXT_UNDERLINE_TYPE,
    MSO_VERTICAL_ANCHOR,
    PP_PARAGRAPH_ALIGNMENT,
)
from pyidml.exc import InvalidXmlError
from pyidml.oxml import parse_xml
from pyidml.oxml.dml.fill import CT_GradientFillProperties
from pyidml.oxml.ns import nsdecls
from pyidml.oxml.simpletypes import (
    ST_Coordinate32,
...
from pyidml.oxml.xmlchemy import (
    BaseOxmlElement,
    Choice,
    OneAndOnlyOne,
    OneOrMore,
...
from pyidml.util import Emu, Length
