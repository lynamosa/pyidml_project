...
from pyidml.enum.shapes import PROG_ID
from pyidml.opc.constants import CONTENT_TYPE as CT, RELATIONSHIP_TYPE as RT
from pyidml.opc.package import XmlPart
from pyidml.opc.packuri import PackURI
from pyidml.oxml.slide import CT_NotesMaster, CT_NotesSlide, CT_Slide
from pyidml.oxml.theme import CT_OfficeStyleSheet
from pyidml.parts.chart import ChartPart
from pyidml.parts.embeddedpackage import EmbeddedPackagePart
from pyidml.slide import NotesMaster, NotesSlide, Slide, SlideLayout, SlideMaster
