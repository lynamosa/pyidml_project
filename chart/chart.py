...
from pyidml.chart.axis import CategoryAxis, DateAxis, ValueAxis
from pyidml.chart.legend import Legend
from pyidml.chart.plot import PlotFactory, PlotTypeInspector
from pyidml.chart.series import SeriesCollection
from pyidml.chart.xmlwriter import SeriesXmlRewriterFactory
from pyidml.compat import Sequence
from pyidml.dml.chtfmt import ChartFormat
from pyidml.shared import ElementProxy, PartElementProxy
from pyidml.text.text import Font, TextFrame
...
class ChartTitle(ElementProxy):
    ...
    # into a base class, perhaps pyidml.chart.shared.BaseTitle. I suspect they
