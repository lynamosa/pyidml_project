...
from pyidml.compat import to_unicode
from pyidml.dml.fill import FillFormat
from pyidml.enum.dml import MSO_FILL
from pyidml.enum.lang import MSO_LANGUAGE_ID
from pyidml.enum.text import MSO_AUTO_SIZE, MSO_UNDERLINE
from pyidml.opc.constants import RELATIONSHIP_TYPE as RT
from pyidml.oxml.simpletypes import ST_TextWrappingType
from pyidml.shapes import Subshape
from pyidml.text.fonts import FontFiles
from pyidml.text.layout import TextFitter
from pyidml.util import Centipoints, Emu, lazyproperty, Pt
...
class TextFrame(Subshape):
    ...
    def margin_bottom(self):
        ...
        frame border. :meth:`pyidml.util.Inches` provides a convenient way of
...
class Font(object):
    ...
    def size(self):
        ...
        units. Likewise, the :class:`pyidml.util.Pt` class allows convenient
