...
from pyidml.shared import PartElementProxy
from pyidml.slide import SlideMasters, Slides
...
class Presentation(PartElementProxy):
    ...
    Not intended to be constructed directly. Use :func:`pyidml.Presentation` to open or
