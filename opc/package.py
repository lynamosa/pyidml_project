...
The :mod:`pyidml.packaging` module coheres around the concerns of reading and writing
presentations to and from a .pptx file.
"""

import collections

from pyidml.compat import is_string, Mapping
from pyidml.opc.constants import RELATIONSHIP_TARGET_MODE as RTM, RELATIONSHIP_TYPE as RT
from pyidml.opc.oxml import CT_Relationships, serialize_part_xml
from pyidml.opc.packuri import CONTENT_TYPES_URI, PACKAGE_URI, PackURI
from pyidml.opc.serialized import PackageReader, PackageWriter
...
class _ContentTypeMap(object):
    ...
    def __getitem__(self, partname):
        ...
        raise KeyError(
            "no content-type for partname '%s' in designmap.xml" % partname
        )
