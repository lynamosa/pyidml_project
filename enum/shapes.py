...
class MSO_AUTO_SHAPE_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.shapes import MSO_SHAPE
        from pyidml.util import Inches
...
class MSO_CONNECTOR_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.shapes import MSO_CONNECTOR
        from pyidml.util import Cm
...
class MSO_SHAPE_TYPE(Enumeration):
    ...
    Example::
        ...
        from pyidml.enum.shapes import MSO_SHAPE_TYPE
...
class PP_MEDIA_TYPE(Enumeration):
    ...
    Example::
        ...
        from pyidml.enum.shapes import PP_MEDIA_TYPE
...
class PP_PLACEHOLDER_TYPE(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.shapes import PP_PLACEHOLDER
