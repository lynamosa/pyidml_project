...
class XL_AXIS_CROSSES(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_AXIS_CROSSES
...
class XL_CATEGORY_TYPE(Enumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_CATEGORY_TYPE
...
class XL_CHART_TYPE(Enumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_CHART_TYPE
...
class XL_DATA_LABEL_POSITION(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_LABEL_POSITION
...
class XL_LEGEND_POSITION(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_LEGEND_POSITION
...
class XL_MARKER_STYLE(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_MARKER_STYLE
...
class XL_TICK_MARK(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_TICK_MARK
...
class XL_TICK_LABEL_POSITION(XmlEnumeration):
    ...
    Example::
        ...
        from pyidml.enum.chart import XL_TICK_LABEL_POSITION
