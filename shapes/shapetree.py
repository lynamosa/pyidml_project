...
from pyidml.compat import BytesIO
from pyidml.enum.shapes import PP_PLACEHOLDER, PROG_ID
from pyidml.media import SPEAKER_IMAGE_BYTES, Video
from pyidml.opc.constants import CONTENT_TYPE as CT
from pyidml.oxml.ns import qn
from pyidml.oxml.shapes.graphfrm import CT_GraphicalObjectFrame
from pyidml.oxml.shapes.picture import CT_Picture
from pyidml.oxml.simpletypes import ST_Direction
from pyidml.shapes.autoshape import AutoShapeType, Shape
from pyidml.shapes.base import BaseShape
from pyidml.shapes.connector import Connector
from pyidml.shapes.freeform import FreeformBuilder
from pyidml.shapes.graphfrm import GraphicFrame
from pyidml.shapes.group import GroupShape
from pyidml.shapes.picture import Movie, Picture
from pyidml.shapes.placeholder import (
    ChartPlaceholder,
    LayoutPlaceholder,
    MasterPlaceholder,
...
from pyidml.shared import ParentedElementProxy
from pyidml.util import Emu, lazyproperty
...
class _BaseGroupShapes(_BaseShapes):
    ...
    def add_ole_object(
        ...
        `prog_id` can be either a member of `pyidml.enum.shapes.PROG_ID` or a str value
